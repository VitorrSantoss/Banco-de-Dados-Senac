...
CREATE TABLE IF NOT EXISTS `loja_roupas`.`tb_produtos` (
    ...
    INDEX `fk_tb_produtos_tb_categoria_produto_idx` (
        `tb_categoria_produto_id_categoria` ASC
    ) VISIBLE,
    INDEX `fk_tb_produtos_tb_marca1_idx` (`tb_marca_id_marca` ASC) VISIBLE,
    INDEX `fk_tb_produtos_tb_fornecedor1_idx` (
        `tb_fornecedor_id_fornecedor` ASC
    ) VISIBLE,
    INDEX `fk_tb_produtos_tb_estoque1_idx` (`tb_estoque_id_estoque` ASC) VISIBLE,
    CONSTRAINT `fk_tb_produtos_tb_categoria_produto` FOREIGN KEY (
        `tb_categoria_produto_id_categoria`
    ) REFERENCES `loja_roupas`.`tb_categoria_produto` (`id_categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_tb_produtos_tb_marca1` FOREIGN KEY (`tb_marca_id_marca`) REFERENCES `loja_roupas`.`tb_marca` (`id_marca`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_tb_produtos_tb_fornecedor1` FOREIGN KEY (`tb_fornecedor_id_fornecedor`) REFERENCES `loja_roupas`.`tb_fornecedor` (`id_fornecedor`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_tb_produtos_tb_estoque1` FOREIGN KEY (`tb_estoque_id_estoque`) REFERENCES `loja_roupas`.`tb_estoque` (`id_estoque`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `loja_roupas`.`tb_vendas` (
    ...
    INDEX `fk_tb_vendas_tb_funcionario1_idx` (
        `tb_funcionario_id_funcionario` ASC
    ) VISIBLE,
    INDEX `fk_tb_vendas_tb_clientes1_idx` (`tb_clientes_id_cliente` ASC) VISIBLE,
    CONSTRAINT `fk_tb_vendas_tb_funcionario1` FOREIGN KEY (
        `tb_funcionario_id_funcionario`
    ) REFERENCES `loja_roupas`.`tb_funcionario` (`id_funcionario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_tb_vendas_tb_clientes1` FOREIGN KEY (`tb_clientes_id_cliente`) REFERENCES `loja_roupas`.`tb_clientes` (`id_cliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `loja_roupas`.`tb_produto_tamanho` (
    ...
    PRIMARY KEY (
        `tb_produtos_id_produto`,
        `tb_tamanho_id_tamanho`
    ),
    ...
    CONSTRAINT `fk_tb_produtos_has_tb_tamanho_tb_produtos1` FOREIGN KEY (`tb_produtos_id_produto`) REFERENCES `loja_roupas`.`tb_produtos` (`id_produto`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_tb_produtos_has_tb_tamanho_tb_tamanho1` FOREIGN KEY (`tb_tamanho_id_tamanho`) REFERENCES `loja_roupas`.`tb_tamanho` (`id_tamanho`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `loja_roupas`.`tb_produto_cor` (
    ...
    CONSTRAINT `fk_tb_produtos_has_tb_cores_tb_produtos1` FOREIGN KEY (`tb_produtos_id_produto`) REFERENCES `loja_roupas`.`tb_produtos` (`id_produto`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_tb_produtos_has_tb_cores_tb_cores1` FOREIGN KEY (`tb_cores_id_cor`) REFERENCES `loja_roupas`.`tb_cores` (`id_cor`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `loja_roupas`.`tb_produto_promocao` (
    ...
    CONSTRAINT `fk_tb_produtos_has_tb_promocao_tb_produtos1` FOREIGN KEY (`tb_produtos_id_produto`) REFERENCES `loja_roupas`.`tb_produtos` (`id_produto`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_tb_produtos_has_tb_promocao_tb_promocao1` FOREIGN KEY (`tb_promocao_id_promocao`) REFERENCES `loja_roupas`.`tb_promocao` (`id_promocao`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
